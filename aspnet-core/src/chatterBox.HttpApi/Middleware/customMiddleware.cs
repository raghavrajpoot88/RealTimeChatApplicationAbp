...
namespace chatterBox.Middleware
{
    public class customMiddleware : IMiddleware
    {
        ...
        public customMiddleware( IServiceScopeFactory scopeFactory, ILogger<customMiddleware> logger
                            ,ICurrentUser currentUser,chatterBoxDbContext dbContext)
        {
            //_next = next;
